...
import { formatDateBr } from "../util/FormateDate";
    ...
    const rows = props.editais.map(edital => {
        return (
            <tr key={edital.id}>
                ...
                <td className="px-6 py-4 text-xs font-medium text-gray-900 whitespace-nowrap">{edital.numero}</td>
                <td className="px-6 py-4 text-xs font-medium text-gray-900 whitespace-nowrap">{edital.ano}</td>
                <td className="px-6 py-4 text-xs font-medium text-gray-900 whitespace-nowrap">{edital.nome}</td>
                <td className="px-6 py-4 text-xs font-medium text-gray-900 whitespace-nowrap">{formatDateBr(edital.vigenteInicio)}</td>
                <td className="px-6 py-4 text-xs font-medium text-gray-900 whitespace-nowrap">{formatDateBr(edital.vigenteFinal)}</td>
                {/* <td className="px-6 py-4 text-sm font-medium text-gray-900 whitespace-nowrap">{edital.link}</td> */}
                <td  className="px-6 py-4 text-xs font-medium text-gray-900 whitespace-nowrap col-span-2">
