...
class MenuNutricionista extends Component {
  render() {
    return (
      ...
      <div className="w-[220px] sticky top-0 pt-4 pl-4 pr-4 bg-[#93c47d] h-screen">
        ...
        <ul className="flex sm:flex-col overflow-hidden content-center justify-center divide-y divide-gray-600">
          <li className="py-2 hover:bg-gray-300">
            <a className="" href="/listarRefeicoes">
              <span className="hidden sm:inline text-sm">Refeições</span>
            </a>
          </li>
          <li className="py-2 hover:bg-gray-300">
            <a className="active:caret-amber-600" href="/listarCardapios">
              <span className="hidden sm:inline text-sm">Cardápios</span>
            </a>
          </li>
          <li className="py-2 hover:bg-gray-300">
            <a className="" href="/">
...
export default MenuNutricionista;
